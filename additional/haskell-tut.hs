-- Tutorial source: http://www.newthinktank.com/2015/08/learn-haskell-one-video/
...
-- Load script with :l haskell-tut
-- :quit exits the GHCi
...
-- Integer : Unbounded whole number, it means that it can be as big as memory can hold
